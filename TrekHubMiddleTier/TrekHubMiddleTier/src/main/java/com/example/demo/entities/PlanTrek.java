...
public class PlanTrek
{
	...
	public PlanTrek(Date start_date, double price, int avail_seats, Date last_date_apply,
	...
	public String toString() {
		return "PlanTrek [plantreks_id=" + plantreks_id + ", start_date=" + start_date + ", price=" + price
				+ ", avail_seats=" + avail_seats + ", last_date_apply=" + last_date_apply + ", trekidobj=" + trekidobj
