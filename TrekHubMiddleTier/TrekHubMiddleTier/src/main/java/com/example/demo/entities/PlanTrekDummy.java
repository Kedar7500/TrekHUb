...
public class PlanTrekDummy 
{
	...
	public PlanTrekDummy(Date start_date, double price, int avail_seats, Date last_date_apply,
			int trek_id, int guide_id, String status) {
		super();
	...
	public String toString() {
		return "PlanTrekDummy [start_date=" + start_date + ", price=" + price + ", avail_seats=" + avail_seats
				+ ", last_date_apply=" + last_date_apply + ", trek_id=" + trek_id + ", guide_id=" + guide_id
				+ ", status=" + status + "]";
	}
